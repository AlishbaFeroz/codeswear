        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src="https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/71swZQ51uML._AC_UX425_.jpg"
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pin mt-5 flex text-sm">
                <input
                ...
                <button
                  ...
                  className="flex ml-3 text-white bg-pink-500 border-0 py-2 px-5 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Check
                </button>
              </div>
              ...
              {service && service != null && (
                <div className="text-green-700 text-sm mt-3">
                  yey! This pincode isserviceable
                </div>
              )}
            </div>
          </div>
